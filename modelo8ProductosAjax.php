...
echo '
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <div class ="row">
                <img src ="'.$imagen1_8.'" id="imagen1_8" width="50%" height="100%" style="display:none">
            </div>
            <div class ="row">
                <img src ="'.$imagen2_8.'" id="imagen2_8" width="50%" height="100%" style="display:none">
            </div>
            <div class ="row">
                <img src ="'.$imagen3_8.'" id="imagen3_8" width="50%" height="100%" style="display:none">
            </div>
        </div>
    ...
    .$currentProduct8->imprmir_tamanios().'
                    </select>
                </div>
            ...
            <div class="row">
                <div class="col-sm-11">
                    ...
                    <ul>
                        ...
                        <li>'.$currentProduct8->imprmir_capacidad($idSize8).'</li><!--Se le debera pasar por atributo el mismo numero que el de la medida-->
