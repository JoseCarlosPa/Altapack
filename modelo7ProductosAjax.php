...
echo '
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <div class ="row">
                <img src ="'.$imagen1_7.'" id="imagen1_7" width="50%" height="100%" style="display:none">
            </div>
            <div class ="row">
                <img src ="'.$imagen2_7.'" id="imagen2_7" width="50%" height="100%" style="display:none">
            </div>
            <div class ="row">
                <img src ="'.$imagen3_7.'" id="imagen3_7" width="50%" height="100%" style="display:none">
            </div>
        </div>
